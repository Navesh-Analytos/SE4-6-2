...
@Entity
public class ClockedHours implements Serializable {
    ...
    public ClockedHours(String id, Employee employee, String empName, Project project, Integer projectID, 
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ClockedHours)) {
            return false;
        }
        ClockedHours other = (ClockedHours) object;
